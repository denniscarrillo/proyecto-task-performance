...
if (isset($_SESSION['usuario'])) {
  ...
  $idObjetoActual = ControladorBitacora::obtenerIdObjeto('gestionPorcentajes.php');
  ...
  ;
  if(!$permisoConsulta){
    /* ==================== Evento intento de ingreso sin permiso a mantenimiento porcentajes. ==========================*/
    ...
    $newBitacora->descripcion = 'El usuario ' . $_SESSION['usuario'] . ' intentó ingresar sin permiso a mantenimiento porcentajes';
    ...
    /* ====================== Evento ingreso a mantenimiento porcentajes. ========================*/
    $accion = ControladorBitacora::accion_Evento();
    date_default_timezone_set('America/Tegucigalpa');
    $newBitacora->fecha = date("Y-m-d h:i:s");
    $newBitacora->idObjeto = ControladorBitacora::obtenerIdObjeto('gestionPorcentajes.php');
    ...
    $newBitacora->descripcion = 'El usuario ' . $_SESSION['usuario'] . ' ingresó a mantenimiento porcentajes';
    ControladorBitacora::SAVE_EVENT_BITACORA($newBitacora);
    $_SESSION['objetoAnterior'] = 'gestionPorcentajes.php';
    $_SESSION['descripcionObjeto'] = 'mantenimiento porcentajes';
    /* =======================================================================================*/
  }
} else {
    ...
    <div class="conteiner-global">
      ...
      <div class="conteiner-main">
          ...
          <div class= "encabezado">
            ...
            <div class ="titulo">
              <H2 class="title-dashboard-task" id="<?php echo ControladorBitacora::obtenerIdObjeto('gestionPorcentajes.php');?>">Gestión de Porcentajes</H2>
            </div>  
          </div>
        ...
        <div>
            ...
            <a href="../../../TCPDF/examples/reporteriaPorcentaje.php" target="_blank" class="btn_Pdf btn btn-primary" id="btn_Pdf"> <i class="fas fa-file-pdf"> </i> Generar PDF</a>
          </div>
