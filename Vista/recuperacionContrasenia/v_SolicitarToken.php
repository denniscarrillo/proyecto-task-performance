...
<body class="container">
    <div class="ancho">
        ...
        <span class="tokenSend" id ="<?php echo (isset($tokenSend) && intval($tokenSend) > 0) ? $tokenSend : 0; ?>" ></span>
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>" method="POST" id="formcorreo">
            ...
            <div>
                ...
                <div class="wrap-input mb-3 mt-3">   
                    ...
                    <input type="text" class="form-control center-token" id="token" maxlength="4" pattern="[0-9]+" name="token" placeholder="Ingresa el token">
