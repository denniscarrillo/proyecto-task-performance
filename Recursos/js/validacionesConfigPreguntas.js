...
$form.addEventListener("submit", (e) => {
  ...
  if (
    estadoValidaciones.MasdeUnEspacioEntrePalabras == false &&
    estadoValidaciones.campoVacioRespuesta == true
  ) {
    e.preventDefault();
...
let preguntaGuardada = (elemento) => {
  if (elemento.id == "1") {
    ...
    Toast.fire({
      icon: "success",
      title:
        "Tu Pregunta N°" + $numPreguntaContestada.id + " ha sido configurada",
    });
  }
};
