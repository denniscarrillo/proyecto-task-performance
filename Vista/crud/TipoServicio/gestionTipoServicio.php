...
if (isset($_SESSION['usuario'])) {
  ...
  if (!$permisoConsulta) {
    ...
    $newBitacora->descripcion = 'El usuario ' . $_SESSION['usuario'] . ' intentó ingresar sin permiso a mantenimiento tipo servicio';
    ...
    /* ====================== Evento ingreso a mantenimiento tipo servicio. ========================*/
    $accion = ControladorBitacora::accion_Evento();
    date_default_timezone_set('America/Tegucigalpa');
    $newBitacora->fecha = date("Y-m-d h:i:s");
    $newBitacora->idObjeto = ControladorBitacora::obtenerIdObjeto('gestionTipoServicio.php');
    ...
    $newBitacora->descripcion = 'El usuario ' . $_SESSION['usuario'] . ' ingresó a mantenimiento tipo servicio';
    ControladorBitacora::SAVE_EVENT_BITACORA($newBitacora);
    $_SESSION['objetoAnterior'] = 'gestionTipoServicio.php';
    $_SESSION['descripcionObjeto'] = 'mantenimiento tipo servicio';
    /* =======================================================================================*/
  }
} else {
        ...
        <div class="encabezado">
          ...
          <div class="titulo">
            <H2 class="title-dashboard-task"
              id="<?php echo ControladorBitacora::obtenerIdObjeto('gestionTipoServicio.php'); ?>">Gestión de Tipos de
              Servicio</H2>
          </div>
        </div>
        ...
        <div class="table-conteiner">
          <div>
            <a href="#" class="btn_nuevoRegistro btn btn-primary hidden" id="btn_nuevoRegistro" data-bs-toggle="modal"
              data-bs-target="#modalNuevoTipoServicio"><i class="fa-solid fa-circle-plus"></i> Nuevo registro</a>
