...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaRubroComercial.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table_RubroComercial_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaRubroComercial.rows().data().toArray();
