...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaDataTableObjeto.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-Objeto_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaDataTableObjeto.rows().data().toArray();
