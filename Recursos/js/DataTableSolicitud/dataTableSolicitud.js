...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaDataTableSolicitud.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-Solicitud_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaDataTableSolicitud.rows().data().toArray();
