...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaTipoServicio.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-TipoServicio_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaTipoServicio.rows().data().toArray();
