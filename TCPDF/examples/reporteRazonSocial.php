...
if(isset($_SESSION['usuario'])){
    ...
    $pdf->setTitle('ReporteRazonSocial');
    ...
    $html = '
    <P style="text-align: center; font-size: 18px;"><b>Reporte de Razón Social</b></P>
    <table border="1" cellpadding="4">
    <tr>
    <td style="background-color: #e54037;color: white; text-align: center; width: 60px;">N°</td>
    <td style="background-color: #e54037;color: white; text-align: center; width: 220px;">RAZÓN SOCIAL</td>
    ...
    ob_end_clean();
    $pdf->Output('ReporteRazonSocial.pdf', 'I');
    ...
    if($filtro != ''){
        /* ========================= Evento generar reporte por filtro. ==============================*/
          ...
          $newBitacora->descripcion = 'El usuario '.$_SESSION['usuario'].' generó el reporte de razón social por el filtro "'.$filtro.'"';
        ...
        $newBitacora->idUsuario = ControladorUsuario::obtenerIdUsuario($_SESSION['usuario']);
        $newBitacora->accion = $accion['Report'];
        $newBitacora->descripcion = 'El usuario '.$_SESSION['usuario'].' generó el reporte de razón social';
        ControladorBitacora::SAVE_EVENT_BITACORA($newBitacora);
        /* =======================================================================================*/
    }
}
