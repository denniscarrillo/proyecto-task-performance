    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="form-Edit-Usuario">
                    <div class="grupo-form">
                        <div class="mb-3" hidden="true">
                            <label for="nombre" class="form-label">ID:</label>
                            <input type="text" name="nombre" id="E_IdUsuario" class="form-control" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="grupo-form">
                        <div class="mb-3">
                            ...
                            <input type="email" name="correo" id="E_correo" class="form-control" required>
                        </div>
                        <div class="mb-3">
                            <label for="rol" class="form-label">Rol:</label>
                            <select name="rol" id="E_rol" class="form-control" required>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="estado" class="form-label">Estado:</label>
                            <select name="estado" id="E_estado" class="form-control" required>
                            </select>
                        </div>
                    </div>
