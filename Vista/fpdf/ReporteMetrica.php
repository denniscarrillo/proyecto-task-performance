 ...
 */
      ...
      $this->Cell(65, 10, mb_convert_encoding('REPORTE DE METRICAS ', 'windows-1252', 'UTF-8'), 0, 2, 'L', 0);
      $this->Ln(7);
      ...
      $this->Cell(50, 10, mb_convert_encoding('META','windows-1252', 'UTF-8'), 1, 0, 'C', 1);
      $this->Ln(10);
   }
...
foreach ($Metricas as $Metrica) {
   $pdf->Cell(18, 10, mb_convert_encoding($Metrica['idMetrica'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, mb_convert_encoding($Metrica['descripcion'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
   $pdf->Cell(50, 10, mb_convert_encoding($Metrica['meta'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
 
   $pdf->Ln(10);
}
/* TABLA */

$pdf->Output('Metricas.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
