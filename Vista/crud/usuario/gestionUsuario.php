      ...
      <!-- CONTENIDO DE LA PAGINA - 2RA PARTE -->
        <div class="conteiner-main">
          ...
          <div class= "encabezado">
            ...
            <div class ="titulo">
              <H2 class="title-dashboard-task" id="<?php echo ControladorBitacora::obtenerIdObjeto('gestionUsuario.php');?>">Gestión de Usuarios</H2>
            </div>  
          </div>
        ...
        <div class="table-conteiner">
          <div>
            ...
            <a href="../../../TCPDF/examples/reporteriaListaUsuario.php" target="_blank" class="btn_Pdf btn btn-primary" id="btn_Pdf"> <i class="fas fa-file-pdf"> </i> Generar PDF</a> 
          </div>
