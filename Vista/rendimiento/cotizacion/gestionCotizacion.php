    ...
    <div class="conteiner-global">
      ...
      <div class="conteiner-main">
        ...
        <div class="encabezado">
          ...
          <div class="titulo">
            <H2 class="title-dashboard-task"
              id="<?php echo ControladorBitacora::obtenerIdObjeto('gestionCotizacion.php'); ?>">Ver Cotizaciones</H2>
          </div>
        </div>
        ...
        <div class="table-conteiner">
          ...
          <table class="display nowrap table" id="table-Cotizacion" style="width:100%">
            <thead>
              <tr>
                <th scope="col"> No. </th>
