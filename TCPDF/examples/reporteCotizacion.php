...
$width = 44; // Define el ancho que desea para su cadena de encabezado
...
$datosCotizacion = ControladorTarea::obtenerDatosCotizacion(intval($_GET['idTarea']));

$datosCotGenerales = ControladorTarea::obtenerDatos(intval($_GET['idTarea']), $_GET['estadoCliente']);
//<div>Estado Cotización: <b>'. $datosCotizacion['detalle']['estado_Cotizacion'] .'</b>
$html = '
...
<div style="display">
    ...
    <br>RTN/DNI: <b>'.$datosCotGenerales['RTN'].'</b>
    <br>Teléfono: <b>'.$datosCotGenerales['TELEFONO'].'</b></div>
</div>
...
if (!empty($datosCotizacion) && isset($datosCotizacion['productos'])) {
...
<td border="1" style="text-align: center; width: 120px;">Lps.  '. $data['detalle']['isv'].'</td>
</tr>

<tr>
<td></td>
<td border="1" style="font-size: 12px;">TOTAL</td>
<td border="1" style="text-align: center; width: 120px;">Lps.  '. $data['detalle']['total_Cotizacion'].'</td>
</tr>
</table>


    <div >Cotización valida por '.$datosCotGenerales['vigencia'].' días.
...
ob_end_clean();
$pdf->Output('ReportedeCotizacion' . $datosCotizacion['detalle']['id_Cotizacion'] . '.pdf', 'I');
