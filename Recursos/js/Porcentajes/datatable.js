...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaPorcentajes.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-Porcentajes_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaPorcentajes.rows().data().toArray();
