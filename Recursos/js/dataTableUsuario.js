...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaUsuarios.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-Usuarios_filter > label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaUsuarios.rows().data().toArray();
