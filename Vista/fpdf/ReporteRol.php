 ...
 */
      ...
      $this->Cell(65, 10, mb_convert_encoding('REPORTE DE ROLES ', 'windows-1252', 'UTF-8'), 0, 2, 'L', 0);
      $this->Ln(7);
      ...
      $this->Cell(40, 10, mb_convert_encoding('ROL','windows-1252', 'UTF-8'), 1, 0, 'C', 1);
      $this->Cell(90, 10, mb_convert_encoding('DESCRIPCION','windows-1252', 'UTF-8'), 1, 0, 'C', 1);
      $this->Ln(10);
   }
...
foreach ($roles as $rol) {
   $pdf->Cell(18, 10, mb_convert_encoding($rol['id_Rol'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
   $pdf->Cell(40, 10, mb_convert_encoding($rol['rol'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
   $pdf->Cell(90, 10, mb_convert_encoding($rol['descripcion'],'windows-1252', 'UTF-8'), 1, 0, 'C', 0);
 
   $pdf->Ln(10);
}
/* TABLA */

$pdf->Output('Roles.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
