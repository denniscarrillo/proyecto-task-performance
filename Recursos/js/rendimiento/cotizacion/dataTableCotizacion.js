...
$(document).on("click", "#btn_PDFid", function() {
  ...
  console.log(creador);
  console.log(cliente);
  window.open('../../../TCPDF/examples/reporteCotizacionID.php?idCotizacion='+idCot + '&usuario='+creador +'&nombreC=' +cliente, '_blank');
});
...
$(document).on("click", "#btn_Pdf", function() {
 ...
 console.log('Estado del cliente:'+estadoCliente)
  ...
  window.open('../../../TCPDF/examples/reporteGeneralCotizacion.php?buscar='+buscar, '_blank');
});
