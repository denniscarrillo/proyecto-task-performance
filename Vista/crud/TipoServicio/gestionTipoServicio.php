      ...
      <div class="conteiner-main">
        ...
        <div class="table-conteiner">
          <div>
            ...
            <a href="../../../TCPDF/examples/reporteServicioTecnico.php" target="_blank" class="btn_Pdf btn btn-primary hidden" id="btn_Pdf"> <i class="fas fa-file-pdf"> </i> Generar PDF</a> 
          </div>
