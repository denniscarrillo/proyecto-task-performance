...
$form.addEventListener("submit", (e) => {
  ...
  if (
    estadoValidaciones.campoVacioUser == false ||
    estadoValidaciones.campoVacioPassword == false
  ) {
    e.preventDefault();
    ...
    console.log(
      estadoValidaciones.espaciosUser +
        " " +
        estadoValidaciones.espaciosPassword
    );
    e.preventDefault();
    ...
    console.log("Entro");
  } else if (estadoValidaciones.soloLetrasUser == false) {
    console.log("Entro");
    e.preventDefault();
    estadoValidaciones.soloLetrasUser = funciones.validarSoloLetras(
      $user,
      validaciones.user
    );
  }
