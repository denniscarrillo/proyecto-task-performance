...
<body>
  <div class="conteiner">
    <div class="row">
      ...
      <div class="columna2 col-10">
        ...
        <a href="../../fpdf/ReportePregunta.php" target="_blank" class="btn btn-success" id="btn_Pdf"> <i class="fas fa-file-pdf"> </i> Generar PDF</a>          </div>
  ...
  <script src="../../../Vista/crud/Pregunta/dataTablePregunta.js" type="module"></script>
