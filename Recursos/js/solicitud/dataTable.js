  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (let i = 0; i < data.length; i++) {
        valores +=
          '<option value="' +
          data[i].id_TipoServicio +
          '">' +
          data[i].servicio_Tecnico +
          "</option>";
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (let i = 0; i < data.length; i++) {
        valores +=
          '<option value="' +
          data[i].id_EstadoSolicitud +
          '">' +
          data[i].estadoSolicitud +
          "</option>";
        $(idElemento).html(valores);
      }
    },
...
$(document).on("click", "#btn_editar", function () {
  ...
  $("#E_idEstadoSolicitud").val(
    obtenerEstadoSolicitudes("#E_idEstadoSolicitud")
  );
