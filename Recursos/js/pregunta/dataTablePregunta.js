...
$(document).on("click", "#btn_Pdf", function () {
  ...
  let cantidadRegistros = tablaPregunta.rows().count();

  // Obtener el valor del filtro de búsqueda
  let buscar = $("#table-Pregunta_filter> label > input[type=search]").val().trim();
...
function hayCoincidencias(buscar) {
  let datos = tablaPregunta.rows().data().toArray();
