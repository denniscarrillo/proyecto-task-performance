    ...
    <div class="conteiner-global">
      ...
      <div class="conteiner-main">
        ...
        <div class= "encabezado">
            ...
            <div class ="titulo">
                  <H1 class="title-dashboard-task" id="<?php echo ControladorBitacora::obtenerIdObjeto('gestionCliente.php');?>">Clientes</H1>
            </div>  
          </div>
        ...
        <div class="table-conteiner">
          <table class="table" id="table-VistaClientes">
            ...
            <!-- <a href="../../../TCPDF/examples/reporteriaClientes.php" target="_blank" class="btn btn-success hidden" id="btn_Pdf"> <i class="fas fa-file-pdf"> </i> Generar PDF</a> -->
