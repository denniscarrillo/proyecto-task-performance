...
if(isset($_SESSION['usuario'])){
    ...
    $pdf->setTitle('ReporteRubroComercial');
    ...
    $html = '
    <P style="text-align: center; font-size: 18px;"><b>Reporte de Rubro Comercial</b></P>
    <table border="1" cellpadding="4">
    <tr>
    <td style="background-color: #e54037;color: white; text-align: center; width: 60px;">No.</td>
    <td style="background-color: #e54037;color: white; text-align: center; width: 220px;">RUBRO COMERCIAL</td>
    ...
    foreach($RubroComerciales  as $rubroComercial){
        ...
        $descripcion = $rubroComercial['descripcion'];
        $contador++;
        $html.='
        <tr>
        <td style="text-align: center;">'.$contador.'</td>
        <td style="text-align: center;">'.$RubroComercial.'</td>
    ...
    ob_end_clean();
    $pdf->Output('ReporteRubroComercial.pdf', 'I');
    ...
    if($filtro != ''){
        /* ========================= Evento generar reporte por filtro. ==============================*/
          ...
          $newBitacora->descripcion = 'El usuario '.$_SESSION['usuario'].' generó el reporte de rubro comercial por el filtro "'.$filtro.'"';
        ...
        $newBitacora->idUsuario = ControladorUsuario::obtenerIdUsuario($_SESSION['usuario']);
        $newBitacora->accion = $accion['Report'];
        $newBitacora->descripcion = 'El usuario '.$_SESSION['usuario'].' generó el reporte de rubro comercial';
        ControladorBitacora::SAVE_EVENT_BITACORA($newBitacora);
        /* =======================================================================================*/
    }
}
